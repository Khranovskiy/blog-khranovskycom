...
Эта статья — продолжение [первой части про payment MVP для checkout]({{< ref "/posts/ru/2026-04-checkout-payments-mvp" >}}).  
...
Если хочется вернуться от framework обратно к более практическому разбору, вот ссылка на [первую часть, начиная с Active axes]({{< ref "/posts/ru/2026-04-checkout-payments-mvp#active-axes" >}})
