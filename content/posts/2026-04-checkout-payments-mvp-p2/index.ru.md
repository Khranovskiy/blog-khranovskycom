...
Если хочется вернуться от framework обратно к более практическому разбору, вот ссылка на [первую часть, начиная с Active axes]({{< ref "/posts/2026-04-checkout-payments-mvp" >}})
